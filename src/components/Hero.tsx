    ...
    <div className="min-h-screen bg-gradient-to-r from-background to-highlight relative overflow-hidden">
      ...
      >
        <motion.div className="max-w-4xl w-full" variants={itemVariants}>
          <motion.h1
            className="text-4xl sm:text-5xl md:text-6xl text-primary font-bold mb-4"
            variants={itemVariants}
          >
            Hey, I'm Patrick Rwirangira.
          </motion.h1>
          <motion.h2
            className="text-3xl sm:text-4xl md:text-5xl text-primary font-medium mb-6"
            variants={itemVariants}
          >
            A Software Engineer
          </motion.h2>
          <motion.p
            className="text-primary text-lg sm:text-xl max-w-2xl mx-auto mb-12"
            variants={itemVariants}
          >
            Designer, developer, and architect of beautifully simple things with
            care. Passionate about creating innovative and user-centric digital
            experiences.
          </motion.p>
          <motion.div
...
const FeatureCard: React.FC<FeatureCardProps> = ({
  ...
  return (
    <motion.div
      className="bg-card text-card-foreground p-6 rounded-lg shadow-lg flex flex-col h-full"
...
const PortfolioIntro = () => {
  return (
    <section className="text-center p-8 bg-background">
      <motion.div
